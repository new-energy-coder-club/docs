...
- ROBOCON 资料包·参赛队整机开源方案（马术/四足）: [/competition/robocon-materials](/competition/robocon-materials#参赛队整机开源方案马术--四足) — 10 个各校整机模型与电控固件压缩包，CDN 直接下载
- 各团队培训课视频汇总: [/wiki/team-training-videos](/wiki/team-training-videos) — 76 门 B 站公开课，机械/电控/视觉/ROS 分类索引
