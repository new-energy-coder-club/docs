...
description: "Generate professional resumes that conform to the Reactive Resume schema. Use when the user wants to create, build, or generate a resume through conv…"
---

| 项目 | 内容 |
|---|---|
| 来源 | [skills/resume-builder/SKILL.md](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/resume-builder/SKILL.md) |
| 分类 | TRAE 内置 & 独立工具 |
| 安装 | 克隆 [Skill 分支](https://github.com/new-energy-coder-club/new_energy_coder_club/tree/Skill) 后，将 `skills/resume-builder/` 目录复制到 `~/.claude/skills/`（Claude Code）、`~/.trae/skills/`（Trae IDE）或 `~/.qclaw/skills/`（QClaw/OpenClaw），详见 [Skill 安装方式](/community/skill-branch) |
...
Output must conform to the Reactive Resume schema. See [references/schema.md](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/resume-builder/references/schema.md) for the complete schema structure.
...
For the complete schema, see [references/schema.md](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/resume-builder/references/schema.md).
