...
| 项目 | 内容 |
|---|---|
| 来源 | [skills/lark-workflow-standup-report/SKILL.md](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/lark-workflow-standup-report/SKILL.md) |
| 分类 | 飞书/Lark 办公套件 |
| 安装 | 克隆 [Skill 分支](https://github.com/new-energy-coder-club/new_energy_coder_club/tree/Skill) 后，将 `skills/lark-workflow-standup-report/` 目录复制到 `~/.claude/skills/`（Claude Code）、`~/.trae/skills/`（Trae IDE）或 `~/.qclaw/skills/`（QClaw/OpenClaw），详见 [Skill 安装方式](/community/skill-branch) |
...
- [lark-calendar](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/lark-calendar/SKILL.md) — `+agenda` 详细用法
- [lark-task](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/lark-task/SKILL.md) — `+get-my-tasks` 详细用法
