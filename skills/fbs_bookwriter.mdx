...
| 项目 | 内容 |
|---|---|
| 来源 | [skills/fbs_bookwriter/SKILL.md](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/fbs_bookwriter/SKILL.md) |
| 分类 | TRAE 内置 & 独立工具 |
| 安装 | 克隆 [Skill 分支](https://github.com/new-energy-coder-club/new_energy_coder_club/tree/Skill) 后，将 `skills/fbs_bookwriter/` 目录复制到 `~/.claude/skills/`（Claude Code）、`~/.trae/skills/`（Trae IDE）或 `~/.qclaw/skills/`（QClaw/OpenClaw），详见 [Skill 安装方式](/community/skill-branch) |
...
**认知资产与商业口径（与主仓一致）**：价值表述统一为「可进化、可分发、可增值」；能力分层统一为「场景包 + 乐包 + 离线/在线会员」。机读见根目录 `fbs-runtime-hints.json` → `cognitiveAsset`；首响 JSON 见 `firstResponseContext.cognitiveAssetSnapshot`。详细说明见 [`references/05-ops/cognitive-asset-threeization.md`](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/fbs_bookwriter/references/05-ops/cognitive-asset-threeization.md)。
...
5. **写作约束**：串行优先；每轮默认最多改 **2** 个文件；详见 [`references/05-ops/agent-task-strategy.md`](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/fbs_bookwriter/references/05-ops/agent-task-strategy.md)。
...
完整表见仓库根目录随包分发的 **WorkBuddy 版 `SKILL.md` 镜像**或 [`references/01-core/intake-and-routing.md`](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/fbs_bookwriter/references/01-core/intake-and-routing.md)。
...
- 落盘：以 `<bookRoot>/.fbs/`、`deliverables/`、`releases/` 为真值；规范见 [`references/01-core/skill-full-spec.md`](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/fbs_bookwriter/references/01-core/skill-full-spec.md)。
...
- **书稿根未就绪**：引导先 `init-fbs-multiagent-artifacts` 或走 S0 最小集（见 [`references/01-core/intake-and-routing.md`](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/fbs_bookwriter/references/01-core/intake-and-routing.md) 脚本不可用降级节）。
...
- 总规范：[`references/01-core/skill-full-spec.md`](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/fbs_bookwriter/references/01-core/skill-full-spec.md)  
- 工作流：[`references/01-core/section-3-workflow.md`](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/fbs_bookwriter/references/01-core/section-3-workflow.md)  
- NLU：[`references/01-core/section-nlu.md`](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/fbs_bookwriter/references/01-core/section-nlu.md)  
- 运行时契约：[`references/01-core/runtime-mandatory-contract.md`](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/fbs_bookwriter/references/01-core/runtime-mandatory-contract.md)
