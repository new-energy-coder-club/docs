---
title: "dogfood"
description: "Systematically explore and test a web application to find bugs, UX issues, and other problems. Use when asked to \"dogfood\", \"QA\", \"exploratory test\",…"
---

| 项目 | 内容 |
|---|---|
| 来源 | [skills/dogfood/SKILL.md](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/dogfood/SKILL.md) |
| 分类 | TRAE 内置 & 独立工具 |
| 安装 | 克隆 [Skill 分支](https://github.com/new-energy-coder-club/new_energy_coder_club/tree/Skill) 后，将 `skills/dogfood/` 目录复制到 `~/.claude/skills/`（Claude Code）、`~/.trae/skills/`（Trae IDE）或 `~/.qclaw/skills/`（QClaw/OpenClaw），详见 [Skill 安装方式](/community/skill-branch) |
...
Read [references/issue-taxonomy.md](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/dogfood/references/issue-taxonomy.md) for the full list of what to look for and the exploration checklist.
...
|-----------|--------------|
| [references/issue-taxonomy.md](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/dogfood/references/issue-taxonomy.md) | Start of session -- calibrate what to look for, severity levels, exploration checklist |

## Templates

| Template | Purpose |
|----------|---------|
| [templates/dogfood-report-template.md](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/dogfood/templates/dogfood-report-template.md) | Copy into output directory as the report file |
