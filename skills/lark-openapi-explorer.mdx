...
| 项目 | 内容 |
|---|---|
| 来源 | [skills/lark-openapi-explorer/SKILL.md](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/lark-openapi-explorer/SKILL.md) |
| 分类 | 飞书/Lark 办公套件 |
| 安装 | 克隆 [Skill 分支](https://github.com/new-energy-coder-club/new_energy_coder_club/tree/Skill) 后，将 `skills/lark-openapi-explorer/` 目录复制到 `~/.claude/skills/`（Claude Code）、`~/.trae/skills/`（Trae IDE）或 `~/.qclaw/skills/`（QClaw/OpenClaw），详见 [Skill 安装方式](/community/skill-branch) |

# OpenAPI Explorer

> **前置条件：** 先阅读 [`../lark-shared/SKILL.md`](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/lark-shared/SKILL.md) 了解认证、身份切换和安全规则。
...
- [lark-skill-maker](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/lark-skill-maker/SKILL.md) — 如需将挖掘到的 API 固化为新 Skill
