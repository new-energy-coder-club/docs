...
description: "Turns product or tech specs into concrete Notion tasks that Claude code can implement. Breaks down spec pages into detailed implementation plans with…"
---

| 项目 | 内容 |
|---|---|
| 来源 | [skills/spec-to-implementation/SKILL.md](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/spec-to-implementation/SKILL.md) |
| 分类 | 开发工程 & 工作流 |
| 安装 | 克隆 [Skill 分支](https://github.com/new-energy-coder-club/new_energy_coder_club/tree/Skill) 后，将 `skills/spec-to-implementation/` 目录复制到 `~/.claude/skills/`（Claude Code）、`~/.trae/skills/`（Trae IDE）或 `~/.qclaw/skills/`（QClaw/OpenClaw），详见 [Skill 安装方式](/community/skill-branch) |
...
See [reference/spec-parsing.md](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/spec-to-implementation/reference/spec-parsing.md) for parsing patterns.
...
See [reference/task-creation.md](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/spec-to-implementation/reference/task-creation.md) for task patterns.
...
See [reference/progress-tracking.md](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/spec-to-implementation/reference/progress-tracking.md) for tracking patterns.
...
See [reference/spec-parsing.md](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/spec-to-implementation/reference/spec-parsing.md) for detailed parsing techniques.
...
See [reference/standard-implementation-plan.md](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/spec-to-implementation/reference/standard-implementation-plan.md) for full plan template.
...
See [reference/progress-tracking.md](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/spec-to-implementation/reference/progress-tracking.md) for detailed patterns.
...
For additional implementation patterns and techniques, see the reference files in [reference/](https://github.com/new-energy-coder-club/new_energy_coder_club/tree/Skill/skills/spec-to-implementation/reference).
...
See [examples/](https://github.com/new-energy-coder-club/new_energy_coder_club/tree/Skill/skills/spec-to-implementation/examples) for complete workflows:

- [examples/api-feature.md](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/spec-to-implementation/examples/api-feature.md) - API feature implementation
- [examples/ui-component.md](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/spec-to-implementation/examples/ui-component.md) - Frontend component
- [examples/database-migration.md](https://github.com/new-energy-coder-club/new_energy_coder_club/blob/Skill/skills/spec-to-implementation/examples/database-migration.md) - Schema changes
